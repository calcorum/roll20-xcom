...
const CHARGENATTRS = [["attribute-health",3,3],["attribute-aim",65,null],["attribute-defense",0,null],["attribute-will",25,null],["attribute-hacking",1,null],["attribute-mobility",11,null],["gear-priWeapon","assaultrifle",null]];
const CHARGENABILS = [["Import-Stats","!import charId=@{character_id}",false],["Update-Token","!updateToken tokenId=@{selected|tokenId}",false]];
const PLAYERMAP = {};
const LOGLEVEL = 3;
const AUTOHIT = false;
...
const WEAPONLIST = {
    ...
    "shotgun":{"id":"shotgun","name":"Shotgun","damage":"3+1d3","critChance":"15","critDamage":"2","noise":"THOOM!","range":SHOTGUNRANGES},
    ...
    "adventmagrifle":{"id":"adventmagrifle","name":"Advent Mag Rifle","damage":"3+1d2","critDamage":"2","noise":"Pew Pew!","range":RIFLERANGES},
    "sawedoffshotgun":{"id":"sawedoffshotgun","name":"Sawed-Off Shotgun","damage":"4+1d5","critChance":"15","critDamage":"2","noise":"THOOM!","range":SAWEDOFFRANGES},
    "smg":{"id":"smg","name":"Submachine Gun","damage":"1+1d3","critDamage":"1","noise":"Pop Pop Pop!","range":SMGRANGES},
};

const GRENADELIST = {
    "frag":{"id":"frag","name":"Frag Grednade","maxDamage":5,"minDamage":2,"diameter":3,"noise":"KABOOM!"}
};
